...
type Location struct {
	...
	ChargingStations []ChargingStation `json:"chargingStations,omitempty"`
	Layover *LayoverCondition `json:"layover,omitempty"`
...
func NewLocation(id string, latitude float64, longitude float64) *Location {
	...
	var layover LayoverCondition = DISALLOW
...
// SetChargingStations gets a reference to the given []ChargingStation and assigns it to the ChargingStations field.
func (o *Location) SetChargingStations(v []ChargingStation) {
	o.ChargingStations = v
}

// GetLayover returns the Layover field value if set, zero value otherwise.
func (o *Location) GetLayover() LayoverCondition {
	if o == nil || IsNil(o.Layover) {
		var ret LayoverCondition
		return ret
	}
	return *o.Layover
}

// GetLayoverOk returns a tuple with the Layover field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Location) GetLayoverOk() (*LayoverCondition, bool) {
	if o == nil || IsNil(o.Layover) {
		return nil, false
	}
	return o.Layover, true
}
...
// SetLayover gets a reference to the given LayoverCondition and assigns it to the Layover field.
