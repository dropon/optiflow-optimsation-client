...
type ChargingStation struct {
	...
	CompletionDuration *int32 `json:"completionDuration,omitempty"`
}
...
// GetCompletionDuration returns the CompletionDuration field value if set, zero value otherwise.
func (o *ChargingStation) GetCompletionDuration() int32 {
	if o == nil || IsNil(o.CompletionDuration) {
		var ret int32
		return ret
	}
	return *o.CompletionDuration
}

// GetCompletionDurationOk returns a tuple with the CompletionDuration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ChargingStation) GetCompletionDurationOk() (*int32, bool) {
	if o == nil || IsNil(o.CompletionDuration) {
		return nil, false
	}
	return o.CompletionDuration, true
}
...
// SetCompletionDuration gets a reference to the given int32 and assigns it to the CompletionDuration field.
func (o *ChargingStation) SetCompletionDuration(v int32) {
	o.CompletionDuration = &v
}
...
func (o ChargingStation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CompletionDuration) {
		toSerialize["completionDuration"] = o.CompletionDuration
	}
