...
type ResourceCosts struct {
	...
	PerLayover *float64 `json:"perLayover,omitempty"`
...
// GetPerLayover returns the PerLayover field value if set, zero value otherwise.
func (o *ResourceCosts) GetPerLayover() float64 {
	if o == nil || IsNil(o.PerLayover) {
		var ret float64
		return ret
	}
	return *o.PerLayover
...
// GetPerLayoverOk returns a tuple with the PerLayover field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResourceCosts) GetPerLayoverOk() (*float64, bool) {
	if o == nil || IsNil(o.PerLayover) {
		return nil, false
	}
	return o.PerLayover, true
}
...
// SetPerLayover gets a reference to the given float64 and assigns it to the PerLayover field.
...
func (o ResourceCosts) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PerLayover) {
		toSerialize["perLayover"] = o.PerLayover
	}
