...
// Depot A depot where pickup orders can be delivered to or delivery orders can be picked up from. When stopping at a depot, first pickup orders are unloaded. Afterwards delivery orders can be loaded in the vehicle. When providing pickup or delivery orders, at least one depot should be specified.
type Depot struct {
