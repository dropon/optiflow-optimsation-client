...
type VehicleCosts struct {
	...
	Overloads []OverloadCost `json:"overloads,omitempty"`
...
// GetOverloads returns the Overloads field value if set, zero value otherwise.
func (o *VehicleCosts) GetOverloads() []OverloadCost {
	if o == nil || IsNil(o.Overloads) {
		var ret []OverloadCost
		return ret
	}
	return o.Overloads
}

// GetOverloadsOk returns a tuple with the Overloads field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VehicleCosts) GetOverloadsOk() ([]OverloadCost, bool) {
	if o == nil || IsNil(o.Overloads) {
		return nil, false
	}
	return o.Overloads, true
}
...
// SetOverloads gets a reference to the given []OverloadCost and assigns it to the Overloads field.
...
func (o VehicleCosts) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Overloads) {
		toSerialize["overloads"] = o.Overloads
	}
