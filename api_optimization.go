...
type ApiDeleteOptimizationRequest struct {
	ctx context.Context
	ApiService *OptimizationAPIService
	id string
}

func (r ApiDeleteOptimizationRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteOptimizationExecute(r)
}

/*
DeleteOptimization Method for DeleteOptimization
...
Deletes the optimization. Also stops the optimization if it is currently running. Zstd or Gzip-encoded content is returned in the response if accepted by the client.
 ...
 @return ApiDeleteOptimizationRequest
*/
func (a *OptimizationAPIService) DeleteOptimization(ctx context.Context, id string) ApiDeleteOptimizationRequest {
	return ApiDeleteOptimizationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *OptimizationAPIService) DeleteOptimizationExecute(r ApiDeleteOptimizationRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OptimizationAPIService.DeleteOptimization")
	if err != nil {
