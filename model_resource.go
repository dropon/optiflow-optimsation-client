...
// Resource A resource that can be assigned to vehicles. Resources are shared assets that cannot be used simultaneously by multiple vehicles. When the optimization schedules two routes that share a resource, they will be separated in time.
