...
type RouteStructure struct {
	...
	Charging []ChargingStructure `json:"charging,omitempty"`
}
...
// GetCharging returns the Charging field value if set, zero value otherwise.
func (o *RouteStructure) GetCharging() []ChargingStructure {
	if o == nil || IsNil(o.Charging) {
		var ret []ChargingStructure
		return ret
	}
	return o.Charging
}
...
// SetCharging gets a reference to the given []ChargingStructure and assigns it to the Charging field.
...
func (o RouteStructure) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Charging) {
		toSerialize["charging"] = o.Charging
	}
