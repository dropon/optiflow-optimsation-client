...
type OrderConstraints struct {
	...
	LoadingIncompatibilities []OrderLoadingIncompatibilityConstraint `json:"loadingIncompatibilities,omitempty"`
}
...
func (o *OrderConstraints) GetLoadingIncompatibilities() []OrderLoadingIncompatibilityConstraint {
	if o == nil || IsNil(o.LoadingIncompatibilities) {
		var ret []OrderLoadingIncompatibilityConstraint
		return ret
	}
...
// SetLoadingIncompatibilities gets a reference to the given []OrderLoadingIncompatibilityConstraint and assigns it to the LoadingIncompatibilities field.
