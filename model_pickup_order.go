...
type PickupOrder struct {
	...
	Delivery *DepotTaskProperties `json:"delivery,omitempty"`
...
// SetDelivery gets a reference to the given DepotTaskProperties and assigns it to the Delivery field.
