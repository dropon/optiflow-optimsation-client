...
type Vehicle struct {
	...
	Battery *VehicleBattery `json:"battery,omitempty"`
...
// SetBattery gets a reference to the given VehicleBattery and assigns it to the Battery field.
